...
Public Class EvalFunctions
    ...
    Public Function Log(ByVal v As Double) As Double
        Return Math.Log(v)
    End Function
    Public Function Sign(ByVal v As Double) As Double
        Return Math.Sign(v)
    End Function
    Public Function Sin(ByVal v As Double) As Double
        Return Math.Sin(v)
    End Function
    Public Function Sinh(ByVal v As Double) As Double
        Return Math.Sinh(v)
    End Function

    Public Function aSin(ByVal v As Double) As Double
        Return Math.Asin(v)
    End Function
    ...
    Public Function Cos(ByVal v As Double) As Double
        Return Math.Cos(v)
    End Function
    Public Function Cosh(ByVal v As Double) As Double
        Return Math.Cosh(v)
    End Function
    Public Function aCos(ByVal v As Double) As Double
        Return Math.Acos(v)
    End Function
    Public Function Tan(ByVal v As Double) As Double
        Return Math.Tan(v)
    End Function
    Public Function Tanh(ByVal v As Double) As Double
        Return Math.Tanh(v)
    End Function
    Public Function aTan(ByVal v As Double) As Double
        Return Math.Atan(v)
    End Function
    ...
    Public Function Exp(ByVal base As Double) As Double
