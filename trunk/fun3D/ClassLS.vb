...
#Region "Methods"
    ...
    Public Sub refreshBuffer()
        ...
        For Each slovo In str
            ...
            Select Case slovo.ToString
                Case "O", "P", "Q"
                    konst = True
                Case "x"
                    m = Matrix.Multiply(Matrix.RotationX(Me.AngleX * CSng(Math.PI) / 180), m)
                    konst = True
                Case "y"
                    m = Matrix.Multiply(Matrix.RotationY(Me.AngleY * CSng(Math.PI) / 180), m)
                    konst = True
                Case "z"
                    m = Matrix.Multiply(Matrix.RotationZ(Me.AngleZ * CSng(Math.PI) / 180), m)
                    konst = True
                Case "u"
