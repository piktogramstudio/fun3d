    ...
    Public Sub refreshBuffer()
        ...
        For u = 0 To Me.Udens - 1
            ...
            For v = 0 To Me.Vdens - 1
                ...
                vertices(0).Position = Vector3.TransformCoordinate(New Vector3(xVal(a), yVal(a), zVal(a)), m)
                vertices(1).Position = Vector3.TransformCoordinate(New Vector3(xVal(b), yVal(b), zVal(b)), m)
                vertices(2).Position = Vector3.TransformCoordinate(New Vector3(xVal(c), yVal(c), zVal(c)), m)
                ...
                vertices(0).Position = Vector3.TransformCoordinate(New Vector3(xVal(a), yVal(a), zVal(a)), m)
                vertices(1).Position = Vector3.TransformCoordinate(New Vector3(xVal(c), yVal(c), zVal(c)), m)
                vertices(2).Position = Vector3.TransformCoordinate(New Vector3(xVal(d), yVal(d), zVal(d)), m)
                vertices(0).Tu = 0
                vertices(0).Tv = 0
                vertices(1).Tu = 1
                vertices(1).Tv = 1
